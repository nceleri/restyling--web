    ...
    <div class="row m-0 p-0 fondo-imagen-tarjeta  align-content-center justify-content-center">
        <div class="col-md-6">
            <div class="jumbotron bg-transparente">
                ...
                <hr class="my-2">
                <p class="lead">
                    <a class="btn pildora-amarilla " href="tarjeta_form.php" role="button">Solicitá tu Tarjeta</a>
                </p>
            </div>
        </div>
    </div>
...
<div id="requisitos_tarjeta" class="container-fluid  m-superior alto mb-5  d-flex bg-danger ">
    <div class="row m-0 p-0 ">
        <div class="fondo-tarjeta-requisito">
            <div class="jumbotron bg-transparente ">
...
<!--  <div id="requisitos_tarjeta" class="container m-superior alto mb-5  d-flex bg-danger">
    <div class="row m-0 p-0	
        align-content-center justify-content-center ">
        <h2 class="text-center my-4 mx-4" >Requisitos Tarjeta de Crédito</h2>
...
<!-- <a class="img-fluid" href="#" data-toggle="modal" data-target="#modal">
            ...
            <img src="../img/1x/RequisitosTarjeta.jpg" class="img-fluid d-none d-md-block" alt="...">
            <img src="../img/1x/RequisitosTarjetaMobile.jpg" class="img-fluid d-md-none" alt="...">
            </a>
        </div>
        </div>
    </div>-->
